...
function reporte_Bateria {
    ...
    while($hostOP -ne '3') {
        ...
        Start-Process msedge $page
        }


        #Opcion [2] del menu
        elseif($hostOP -eq '2') {
            Remove-Item .\battery-report.html -ErrorAction SilentlyContinue
            Remove-Item .\htmlPage.txt -ErrorAction SilentlyContinue
...
Write-Host 'Para usar la funcion, escriba: reporte_Bateria'
